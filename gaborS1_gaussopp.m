function g = gaborS1_gaussopp(stim,filters, fSiz, c1SpaceSS, c1ScaleSS, c1OL,numChannel)
...
for iBand = 1:numScaleBands
    for iScale = 1:length(ScalesInThisBand{iBand})
        ...
        sc = (iBand-1)*length(ScalesInThisBand{iBand}) + iScale;
            ...
            s1{iBand}{iScale} = double_opponents_gaussian(stim,filters{sc},numChannel);%double opponent simple cell
