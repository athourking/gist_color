function g = gaborS1_dopp_norm_4phase(stim, filter,filters, fSiz, c1SpaceSS, c1ScaleSS, c1OL,numChannel)
...
%         ss1{iBand}{iScale} = sqrt(s1{1}{iBand}{iScale}.^2 + s1{2}{iBand}{iScale}.^2);
         ss1{iBand}{iScale} = (s1{1}{iBand}{iScale} + s1{2}{iBand}{iScale} + s1{3}{iBand}{iScale} + s1{4}{iBand}{iScale}) / numPhases;
