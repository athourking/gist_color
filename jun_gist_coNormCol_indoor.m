...
function F = jun_gist_coNormCol_indoor(mode)
...
%     else
    ...
    save(fullfile(outDir,sprintf('F_c1NormCol_indoor_%i_orient_%i_scene_%i_dataset.mat', ...
...
%            length(rot), ii)) ,'F','-v7.3');
  save(fullfile(outDir,sprintf('F_c1NormCol_indoor_%i_orient_%i_dataset.mat', ...
           length(rot),ii)) ,'F','-v7.3');
