...
function F = jun_gist_s1do_nonmaxS1_indoor(mode)
...
% ii =1;
    ...
    outFile = fullfile(outDir,sprintf('F_do_nonmax_%i_scene_%i_dataset.mat', ...
            n,ii));
    ...
    save(fullfile(outDir,sprintf('F_do_nonmax_%i_scene_%i_dataset.mat', ...
            n,ii)) ,'F','-v7.3');
    end
    end
% end

save(fullfile(outDir,sprintf('Ffin_do_nonmaxS1_indoor_%i_orient_%i_dataset.mat', ...
