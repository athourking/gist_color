...
F = zeros([numel(cI{ii}) Nfeatures]);
    ...
    for n = 1:numel(cI{ii})
%     disp([n Nscenes]);
    outFile = fullfile(outDir,sprintf('F_c1NormCol_nonmaxS1_indoor_%i_orient_%i_scene_%i_dataset.mat', ...
            length(rot),n,ii));
    ...
    save(fullfile(outDir,sprintf('F_c1NormCol_nonmaxS1_indoor_%i_orient_%i_scene_%i_dataset.mat', ...
...
save(fullfile(outDir,sprintf('Ffin_c1NormCol_nonmaxS1_%i_orient_%i_dataset.mat', ...
           length(rot), ii)) ,'F','-v7.3');
