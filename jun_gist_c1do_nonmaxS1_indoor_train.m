...
% for ii = 1:2
    ...
    for n = 1:numel(cI{ii})
%     outFile = fullfile(outDir,sprintf('Ftest_do_nonmaxS1_indoor_%i_orient_%i_scene_%i_dataset.mat', ...
%            length(rot), n,ii));
%         
...
%     else
   ...
   save(fullfile(outDir,sprintf('Ftrain_do_nonmaxS1_indoor_%i_orient_%i_scene.mat', ...
           length(rot), n)) ,'F','-v7.3'); 
...
save(fullfile(outDir,sprintf('Ftrain_do_nonmaxS1_indoor_%i_orient.mat', ...
           length(rot))) ,'F','-v7.3');
