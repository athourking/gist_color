function g = gaborS1_dopp_norm_1scale(stim, filter,filters, fSiz, c1SpaceSS, c1ScaleSS, c1OL,numChannel)
...
g = gistGabor_S1_opp(sss1,numScaleBands,1,numChannel/2,numSimpleFilters);
