...
% for ii = 1:2
    ...
    for n = 3034:numel(cI{ii})
        n
    outFile = fullfile(outDir,sprintf('Ftrain_do_indoor_%i_orient_%i_scene.mat', ...
           length(rot), n));
   ...
   save(fullfile(outDir,sprintf('Ftrain_do_indoor_%i_orient_%i_scene.mat', ...
           length(rot), n)) ,'F','-v7.3'); 
...
save(fullfile(outDir,sprintf('Ftrain_do_indoor_%i_orient.mat', ...
           length(rot))) ,'F','-v7.3');
