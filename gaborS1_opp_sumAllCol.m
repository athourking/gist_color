function g = gaborS1_opp_sumAllCol(stim, filter,filters, fSiz, c1SpaceSS, c1ScaleSS, c1OL,numChannel)
...
%             for jj = 1:numChannel/2
                 sss1{iBand}{iScale} = shiftdim(shiftdim(sum(ss1{iBand}{iScale},3),3),1);
%             end
%       end
