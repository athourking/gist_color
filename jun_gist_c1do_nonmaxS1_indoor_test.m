...
% for ii = 1:2
    ...
    for n = 578:numel(cI{ii})
    outFile = fullfile(outDir,sprintf('Ftest_do_nonmaxS1_indoor_%i_orient_%i_scene.mat', ...
           length(rot), n));
   ...
   save(fullfile(outDir,sprintf('Ftest_do_nonmaxS1_indoor_%i_orient_%i_scene.mat', ...
           length(rot), n)) ,'F','-v7.3'); 
...
save(fullfile(outDir,sprintf('Ftest_do_nonmaxS1_indoor_%i_orient.mat', ...
           length(rot))) ,'F','-v7.3');
