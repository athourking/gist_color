...
function g = gaborS1_dopp_maxCol(stim, filter,filters, fSiz, c1SpaceSS, c1ScaleSS, c1OL,numChannel)
...
g = gistGabor_V1(c1,numScaleBands,numChannel/2,numSimpleFilters);
