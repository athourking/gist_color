...
% [fSiz_gabor,filter_gabor, filters_gabor,c1OL,numSimpleFilters_gabor] = init_color_gabor(rot, RF_siz, Div,numChannel);
[fSiz_gauss,filters_gauss,c1OL,numSimpleFilters_gauss] = init_color_gaussian(RF_siz,numChannel);


Nfeatures = length(RF_siz)*numberBlocks^2 * numChannel;
% % 
...
%     g_do = gaborS1_dopp_norm(output, filter_gabor,filters_gabor, fSiz_gabor, c1SpaceSS, ...
...
%     output = prefilt(double(img), fc_prefilt);
    ...
    g_type2 = gaborS1_gaussopp_norm(output, filters_gauss, fSiz_gauss, c1SpaceSS,...
        c1ScaleSS, c1OL,numChannel);
...
save F_S1_6scales_type2_norm_rect F
save perf_S1_6scales_type2_norm_rect perf
