function g = gaborS1_dopp_norm_1phase(stim, filter,filters, fSiz, c1SpaceSS, c1ScaleSS, c1OL,numChannel)
...
%          ss1{iBand}{iScale} = (s1{1}{iBand}{iScale} + s1{2}{iBand}{iScale}) / numPhases;
         ...
         for iFilt = 1:numSimpleFilters %
            for jj = 1:numChannel/2
                 sss1{iBand}{iScale}(:,:,jj,iFilt) = max( s1{1}{iBand}{iScale}(:,:,jj,iFilt), s1{1}{iBand}{iScale}(:,:,jj+numChannel/2,iFilt));
            end
         end
