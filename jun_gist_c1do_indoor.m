...
function F = jun_gist_c1do_indoor(mode)
...
height = 200;
    ...
    outFile = fullfile(outDir,sprintf('F_do_%i_scene_%i_dataset.mat', ...
            n));
    ...
    save(fullfile(outDir,sprintf('F_do_%i_scene_%i_dataset.mat', ...
            n)) ,'F','-v7.3');
    end
    end

save(fullfile(outDir,sprintf('Ffin_do_indoor_%i_orient_%i_dataset.mat', ...
           length(rot))) ,'F','-v7.3');
