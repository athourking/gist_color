...
imgDir = '/gpfs/data/tserre/jzhang/ColorGist/images/spatial_envelope_256x256_static_8outdoorcategories';
...
Nscenes = 2680;
Nfeatures.so = length(rot)*(length(c1ScaleSS)-1)*numberBlocks^2*numChannels*numPhases;
Nfeatures.do = length(rot)*length(RF_siz)*numberBlocks^2 * numChannels/2;
