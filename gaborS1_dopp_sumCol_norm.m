function g = gaborS1_dopp(stim, filter,filters, fSiz, c1SpaceSS, c1ScaleSS, c1OL,numChannel)
...
for iBand = 1:numScaleBands
    for iScale = 1:length(ScalesInThisBand{iBand})
        ...
        for iPhase = 1:numPhases
            s1{iPhase}{iBand}{iScale} = double_opponents_normS1(stim,filter{sc}{1},filters{sc}{iPhase},numChannel,numSimpleFilters);%double opponent simple cell
