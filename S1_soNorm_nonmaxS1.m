function g = S1_soNorm_nonmaxS1(stim, filters, fSiz, c1SpaceSS, c1ScaleSS, c1OL,numChannel,numPhases)
...
g = gistGabor_S1_opp(ss1,numScaleBands,numel(ss1{iBand}),numChannel,numSimpleFilters);
