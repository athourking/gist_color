function g = gaborS1_phase_scales(stim, filters, fSiz, c1SpaceSS, c1ScaleSS, c1OL,INCLUDEBORDERS)
...
numSimpleFilters=floor(length(fSiz)/numScales)-1; %4������
% numSimpleFilters=4;
