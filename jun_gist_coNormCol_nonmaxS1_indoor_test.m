...
%         nn = n+3261;
% %     disp([n Nscenes]);
    outFile = fullfile(outDir,sprintf('Ftest_c1NormCol_nonmaxS1_indoor_%i_orient_%i_scene.mat', ...
            length(rot),nn));
    ...
    save(fullfile(outDir,sprintf('Ftest_c1NormCol_nonmaxS1_indoor_%i_orient_%i_scene.mat', ...
...
%            length(rot), ii)) ,'F','-v7.3');
  save(fullfile(outDir,sprintf('F_c1NormCol_nonmaxS1_indoor_%i_orient_%_dataset.mat', ...
           length(rot),ii)) ,'F','-v7.3');
