...
%     else
    ...
    save(fullfile(outDir,sprintf('Ftrain_c1NormCol_nonmaxS1_indoor_%i_orient_%i_scene.mat', ...
...
%            length(rot), ii)) ,'F','-v7.3');
  save(fullfile(outDir,sprintf('Ftrain_c1NormCol_nonmaxS1_indoor_%i_orient.mat', ...
           length(rot))) ,'F','-v7.3');
