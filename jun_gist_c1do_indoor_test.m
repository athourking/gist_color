...
% for ii = 1:2
    ...
    for n = 905:numel(cI{ii})
    outFile = fullfile(outDir,sprintf('Ftest_do_indoor_%i_orient_%i_scene.mat', ...
           length(rot), n));
   ...
   save(fullfile(outDir,sprintf('Ftest_do_indoor_%i_orient_%i_scene.mat', ...
           length(rot), n)) ,'F','-v7.3'); 
    end
