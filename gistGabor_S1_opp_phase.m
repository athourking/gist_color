function g = gistGabor_S1_opp_phase(s1,numScaleBands,numScales,numChannel,numSimpleFilters,numPhases)
%
% Input:
...
N = numChannel;
w = 4;
Nfilters = numScaleBands * numScales * numSimpleFilters * numPhases;
...
for iBand = 1:numScaleBands
    for iScale = 1:numScales %�ӵ�һ���߶ȿ�ʼѭ��
        ...
        for iFilt = 1:numSimpleFilters %�ӵ�һ������ʼѭ��
            ...
            ig = s1{iBand}{iScale}(:,:,:,iFilt,iPhase);
            v = downN(ig, w);
