...
[fSiz,filter, filters,c1OL,numSimpleFilters] = init_color_realgabor(rot, RF_siz, Div,numChannel);
...
%     g = gaborS1_phase(output, filters, fSiz, c1SpaceSS, c1ScaleSS, c1OL,numPhases);
    g = gaborS1_opp_sumAllCol(output, filter,filters, fSiz, c1SpaceSS, ...
...
save F_S1_6scales_opp_sumCol F
% figure
% subplot(121)
