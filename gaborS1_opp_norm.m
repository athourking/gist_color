function g = gaborS1_opp_norm(stim, filter,filters, fSiz, c1SpaceSS, c1ScaleSS, c1OL,numChannel)
...
for iBand = 1:numScaleBands
    for iScale = 1:length(ScalesInThisBand{iBand})
        ...
        for iPhase = 1:numPhases
            s1{iPhase}{iBand}{iScale} = single_opponents_normS1(stim,filters{sc}{iPhase},numChannel,numSimpleFilters);%double opponent simple cell
...
g = gistGabor_S1_opp(ss1,numScaleBands,2,numChannel,numSimpleFilters);
