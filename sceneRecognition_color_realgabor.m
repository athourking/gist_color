...
filters =  init_color_realgabor(orientationsPerScale, imageSize,numChannel);
Nfeatures = sum(orientationsPerScale)*numberBlocks^2*numChannel;
% % 
...
% %         img = imresize(img,[imageSize NaN]);
    ...
    g = gaborS1_opp_norm_real(output,  filters,numChannel);
...
save F_realgabor_opp F
save perf_realgabor_opp perf
