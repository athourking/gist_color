...
[fSiz,filters,c1OL,numSimpleFilters] = init_gabor(rot, RF_siz, Div); %Thomas's gabor
...
%     g = gistGabor(output, numberBlocks, G);
    g = gaborS1(output, filters, fSiz, c1SpaceSS, c1ScaleSS, c1OL);
...
save F_S1_16scales_1phase F
save perf_S1_16scales_1phase perf
